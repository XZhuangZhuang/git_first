...
def qiushibaike():
     ...
     content = requests.get('http://www.qiushibaike.com/text/', headers=headers).content
     soup = BeautifulSoup(content, 'html.parser')

     for div in soup.find_all('div', {'class': 'article block untagged mb15 typs_long'}):
          print div.span.get_text()
     ...
     #
     # divs = soup.find_all(class_='article block untagged mb15 typs_long')
     #
     # for div in divs:
